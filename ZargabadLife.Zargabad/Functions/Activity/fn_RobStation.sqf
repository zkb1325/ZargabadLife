...
*/
if (playersNumber west < SETTING(getNumber,"ZKB_StationRobReqCops")) exitWith {["STR_Robbing_RequiredCops",[SETTING(getNumber,"ZKB_StationRobReqCops")]] call ZKB_fnc_DynamicText;};
...
["STR_Admin_PlayerLogsRobbedShop",name player,_shopName,[_robAmount] call ZKB_fnc_FormatNumber] call ZKB_fnc_AdminAddPlayerLog;
